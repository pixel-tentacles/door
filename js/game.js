...
function linkChangey(){
	if(yourMessage.value==""){
		yourLink.value = "https://pixel-tentacles.github.io/door/";
	}else{
		yourLink.value = "https://pixel-tentacles.github.io/door/#"+encodeURIComponent(encryptString(yourMessage.value));
	}
};
